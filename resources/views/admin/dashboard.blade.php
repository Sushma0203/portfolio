...
<div class="row g-4">
    <div class="col-sm-12 col-md-4">
        <a href="{{ route('admin.gallery.index') }}" class="text-decoration-none clickable-card">
        <div class="glass-card overflow-hidden">
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <p class="text-muted mb-1 fw-medium small">Gallery Images</p>
                        <h2 class="fw-bold mb-0 text-purple">{{ $galleryCount }}</h2>
                    </div>
    ...
    <div class="col-sm-12 col-md-4">
        <a href="{{ route('admin.projects.index') }}" class="text-decoration-none clickable-card">
        <div class="glass-card overflow-hidden">
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <p class="text-muted mb-1 fw-medium small">Total Projects</p>
                        <h2 class="fw-bold mb-0 text-purple">{{ $projectCount }}</h2>
                    </div>
    ...
    <div class="col-sm-12 col-md-4">
        <a href="{{ route('admin.messages.index') }}" class="text-decoration-none clickable-card">
        <div class="glass-card overflow-hidden">
            <div class="card-body p-4">
                <div class="d-flex align-items-center justify-content-between">
                    <div>
                        <p class="text-muted mb-1 fw-medium small">New Messages</p>
                        <h2 class="fw-bold mb-0 text-purple">{{ $messageCount }}</h2>
                    </div>
    ...
    <div class="col-md-12">
        <div class="glass-card p-5 overflow-hidden position-relative">
            <div class="row align-items-center position-relative z-1">
                <div class="col-lg-8">
                    <h1 class="fw-bold mb-3 display-6">Welcome back, <span class="text-gradient">Sushma!</span></h1>
            ...
            <div class="position-absolute top-0 end-0 p-5 mt-n5 me-n5 bg-deep-purple opacity-5 rounded-circle" style="width: 300px; height: 300px;"></div>
        </div>
    </div>
</div>
